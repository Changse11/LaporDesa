...
<body>
  <main>
    <section class="hero animate">
      <div class="hero-text">
        ...
        <div class="hero-actions">
          <a href="laporan-form.php" class="btn btn-primary">Mulai Lapor →</a>
          <a href="tentang.php" class="btn btn-outline">Pelajari Selengkapnya</a>
        </div>
      </div>
      <div class="hero-img animate delay-1">
        <img src="../../assets/img/desa.jpg" alt="Foto Desa Kutapohaci"/>
      </div>
    </section>
    ...
    <div class="cta-banner animate delay-3">
      ...
      <button class="btn-cta" onclick="window.location.href='laporan-form.php'">Buat Laporan Sekarang</button>
    </div>
  </main>
